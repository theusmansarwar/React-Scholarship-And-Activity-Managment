                        ...
                        <div className="form-area5">
                            <form onSubmit={handleSubmit}>
                                <div className="inputdiv">
                                    <label>
                                        Scholarship Type:<br />
                                        <select name="scholarshipType" value={formData.scholarshipType} required onChange={handleInputChange}>
                                ...
                                <div className="inputdiv">
                                    <label>
                                        ...
                                        <select name="scholarshipTitle" value={formData.scholarshipTitle} required onChange={handleInputChange}>
                                ...
                                <div className="inputdiv">
                                    <label>
                                        ...
                                        <textarea
                                            ...
                                            required
                                            onChange={handleInputChange}
                                            placeholder="Enter list of required documebnts for applications"
                                        />
                                    </label>
                                    <br />
                                </div>
                                ...
                                <div className="inputdiv">
                                    <label>
                                        Scholarship Detail info link:<br />
                                        <input
                                            type="link"
                                            name="detaillink"
